...
const OrbitalVisualization = dynamic(
  () => import("@/components/3d/orbital-visualization").then(mod => ({ default: mod.OrbitalVisualization })),
  {
    ssr: false,
...
const properties = [
  {
    ...
    value: "+3, +4",
    description: "Most stable as +3, can form +4 in some compounds. The +3 state is characteristic of lanthanides.",
  },
  {
    icon: Droplets,
    title: "Reactivity",
    value: "Moderate",
    description: "Reacts slowly with oxygen at room temperature, rapidly when heated. Forms Pr₂O₃ oxide layer.",
  },
  {
    icon: Magnet,
    title: "Magnetic Properties",
    value: "Paramagnetic",
    description: "Exhibits paramagnetic behavior due to unpaired 4f electrons. Used in permanent magnets.",
  },
  {
    icon: Thermometer,
    title: "Melting Point",
    value: "931°C",
    description: "Relatively low melting point for a rare earth metal. Boiling point is 3,520°C.",
  },
]
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto text-pretty">
            Understanding the chemical behavior of Praseodymium through its electron configuration, 
            oxidation states, and unique properties.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {properties.map((prop, index) => (
            ...
            >
              ...
              <h3 className="text-lg font-semibold mb-1 text-foreground">{prop.title}</h3>
              <div className="text-2xl font-bold text-accent mb-2">{prop.value}</div>
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          ...
          >
            <div className="p-6 rounded-xl bg-card/50 backdrop-blur-sm border border-border">
              <h3 className="text-xl font-semibold mb-4 text-foreground">Orbital Visualization</h3>
              <p className="text-sm text-muted-foreground mb-4">
                Click on an orbital to visualize its shape. The 4f orbitals are key to 
            ...
            <div className="p-6 rounded-xl bg-card/50 backdrop-blur-sm border border-border">
              <h3 className="text-xl font-semibold mb-4 text-foreground">Electronic Configuration</h3>
              ...
              <div className="mt-4 text-sm text-muted-foreground">
                <span className="text-primary">Highlighted:</span> Valence electrons (4f³ 6s²)
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="p-6 rounded-xl bg-card/50 backdrop-blur-sm border border-border">
              <h3 className="text-xl font-semibold mb-4 text-foreground">Position in Periodic Table</h3>
              ...
              <div className="mt-6 grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <div className="text-xl font-bold text-primary">Lanthanide</div>
                </div>
                <div>
                  <div className="text-muted-foreground">Block</div>
                  <div className="text-xl font-bold text-foreground">f-block</div>
                </div>
                <div>
                  <div className="text-muted-foreground">Category</div>
                  <div className="text-xl font-bold text-foreground">Rare Earth</div>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-xl bg-card/50 backdrop-blur-sm border border-border">
              <h3 className="text-xl font-semibold mb-4 text-foreground">Physical Properties</h3>
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground">Crystal Structure</span>
                  <span className="font-mono text-foreground">DHCP</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-muted-foreground">Appearance</span>
                  <span className="font-mono text-foreground">Silvery-white</span>
                </div>
                <div className="flex justify-between items-center">
