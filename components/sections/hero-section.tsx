        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="space-y-4">
              ...
              >
                Лантанойдын цувралд багтах, мөнгөлөг цагаан өнгийн ховор шороон
                металл болох 59-р элементийн сонирхол татам шинж чанарыг таниж мэдэцгээе. Түүний ногоон өнгийн давснаас улбаалж уг элементэд
            ...
            >
              ...
              <p className="text-muted-foreground text-justify">
                ...
                хэмээх материалаас празеодим, неодим элементүүдийг ялган
                гаргаж авсан байна.
              </p>
            </motion.div>
          </motion.div>
