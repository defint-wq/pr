...
const compounds: Compound[] = [
  {
    id: "oxide",
    name: "Празеодимиум Оксид",
    formula: "Pr₂O₃ / Pr₆O₁₁",
    description:
      "Празеодимиум нь хүчилтөрөгчтэй урвалд орж үүсдэг хар эсвэл хар ногоон нунтаг. Хамгийн түгээмэл хэлбэр нь Pr₆O₁₁ юм.",
    properties: [
  ...
  {
    id: "chloride",
    name: "Празеодимиум Хлорид",
    formula: "PrCl₃",
    description:
      "Усанд сайн уусдаг ногоон кристал бүтэцтэй нэгдэл. Празеодимиумын химийн процессын чухал зуучлагч бодис юм.",
    properties: [
  ...
  {
    id: "fluoride",
    name: "Празеодимиум фторид",
    formula: "PrF₃",
    description:
      "Бусад празеодимиумын галогенидээс харьцангуй идэвх багатай ногоон хатуу бодис. Тусгай оптик хэрэглээнд ашиглагддаг.",
    properties: [
      "Ногоон хатуу бодис",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto text-pretty">
            Празеодимиумын гол нэгдлүүдийг 3D молекулын бүтэцтэйгээр судлаарай.
